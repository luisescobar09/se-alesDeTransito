        ...
        if 'myfile' in x:
            ...
            for i in prediction: 
                if i[0] > 0.65:
                    ...
                    titulo= cabeza+"<h1 class='text-danger text-center'>La imagen es una señal de Incorporación de transito.</h1> <br> <br> <h2 class='text-info'>Descripción:</h2> <h3>Este tipo de señalamiento avisa sobre la incorporación de transito que va en la misma.</h3><br> <img src='https://lh3.googleusercontent.com/proxy/4Bhtmwyey0ukSpmwrHYgcyGgZYZ3gPO4jY6YVRmkkaSuUhC5JvgxNZdQaADAblb9peuYtGql2NHt__fFfGYMBHk-7hqkfpffnVOQzt0LSavylxDuZSmsXWWP_k1eC9OWIK6vAmIPGQsllcbmAHuBNPBPEXIsoVdYe6lhGdIjhKZjtb9Z9-k9oWs2MbKO' align='center' width='300' height='275'> <br><br>"+final
                elif i[4] > 0.65:
